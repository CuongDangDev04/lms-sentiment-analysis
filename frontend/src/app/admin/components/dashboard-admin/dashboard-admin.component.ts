...
import { ManagerCoursesAdminComponent } from "../manager-courses-admin/manager-courses-admin.component";
import { FeedbackManagerAdminComponent } from "../feedback-manager-admin/feedback-manager-admin.component";
...
@Component({
  ...
  imports: [SentimentAnalystisAdminComponent, ManagerUsersAdminComponent, ManagerCoursesAdminComponent, FeedbackManagerAdminComponent]
})
